...
BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE := 5690830848
BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE := 2415919104
BOARD_SUPER_PARTITION_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_VENDOR_DEVICE_SIZE) + $(BOARD_SUPER_PARTITION_SYSTEM_DEVICE_SIZE) )

BOARD_SUPER_PARTITION_GROUPS := chen_dynamic_partitions
BOARD_CHEN_DYNAMIC_PARTITIONS_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 ) # Reserved 4 MiB Only because of non-AB update devices
BOARD_CHEN_DYNAMIC_PARTITIONS_PARTITION_LIST := odm product system system_ext vendor

BOARD_FLASH_BLOCK_SIZE := 262144 # (BOARD_KERNEL_PAGESIZE * 64)
BOARD_CACHEIMAGE_FILE_SYSTEM_TYPE := ext4

# Build ext4 for userdebug
...
BOARD_VENDORIMAGE_PARTITION_RESERVED_SIZE := 92160000 # 90M
BOARD_ODMIMAGE_PARTITION_RESERVED_SIZE := 92160000 # 90M
endif

# Build erofs by default
