...
class DozeSettingsFragment : PreferenceFragment(), Preference.OnPreferenceChangeListener,
    ...
    private var moveDetectPreference: ListPreference? = null
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        moveDetectPreference = findPreference(Utils.GESTURE_MOVE_DETECT_KEY)
        moveDetectPreference?.isEnabled = dozeEnabled
        moveDetectPreference?.onPreferenceChangeListener = this
    ...
    override fun onSwitchChanged(switchView: Switch, isChecked: Boolean) {
        ...
        moveDetectPreference?.isEnabled = isChecked
