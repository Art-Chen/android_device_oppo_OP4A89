...
class DozeService : Service() {
    ...
    private lateinit var moveDetectSensor: MoveDetectSensor
    ...
    override fun onCreate() {
        ...
        moveDetectSensor = MoveDetectSensor(this, resources.getString(R.string.move_detect_sensor_type))
    ...
    private fun onDisplayOn() {
        ...
        if (Utils.isMoveDetectEnabled(this)) {
            moveDetectSensor.disable()
        }
    }
