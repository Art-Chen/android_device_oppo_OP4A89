...
public interface IAuthenticatorCallback extends IBase {
    ...
    static IAuthenticatorCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof IAuthenticatorCallback)) {
            return (IAuthenticatorCallback) iface;
        }
        IAuthenticatorCallback proxy = new Proxy(binder);
        try {
    ...
    static IAuthenticatorCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IAuthenticatorCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IAuthenticatorCallback getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static IAuthenticatorCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static IAuthenticatorCallback getService() throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements IAuthenticatorCallback {
        ...
        public IHwInterface queryLocalInterface(String descriptor) {
            if (IAuthenticatorCallback.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                _hidl_request.enforceInterface(IAuthenticatorCallback.kInterfaceName);
                onAuthenticationError(_hidl_request.readInt32());
                ...
                _hidl_request.enforceInterface(IAuthenticatorCallback.kInterfaceName);
                onAuthenticationStatus(_hidl_request.readInt32());
                ...
                _hidl_request.enforceInterface(IAuthenticatorCallback.kInterfaceName);
                onAuthenticationFailed(_hidl_request.readInt32());
            }
        }
    }
}
